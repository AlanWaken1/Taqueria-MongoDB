...
export default function ComprasPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Actualizar lista de productos (stock actualizado)
      const productosRes = await fetch('/api/productos');
      const productosData = await productosRes.json();
      setProductos(productosData);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          <div className="card-header">
            <h2 className="text-xl font-semibold text-white">Registrar Nueva Compra</h2>
          </div>
              ...
              <div className="space-y-4">
                {compras.map(compra => (
                  <div 
                    ...
                    className="p-4 rounded-lg bg-[#1e293b] border border-[#334155] shine flex flex-col"
                  >
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        <span className="bg-[#334155] text-white px-2 py-1 rounded text-xs mr-2">
